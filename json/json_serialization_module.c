...
WJElement get_create_request_object(struct sql_node *node) {
...
WJElement get_select_request_object(struct sql_node *node) {
...
WJElement get_update_request_object(struct sql_node *node) {
    WJElement element = NULL;
    element = WJEObject(NULL, NULL, WJE_NEW);
...
WJElement get_insert_request_object(struct sql_node *node) {
    WJElement element = NULL;
    element = WJEObject(NULL, NULL, WJE_NEW);
...
WJElement get_delete_request_object(struct sql_node *node) {
...
WJElement get_json_request_object(struct sql_node *node) {
    ...
    if (strcmp(query_type, "create") == 0) {
        return get_create_request_object(node);
    } else if (strcmp(query_type, "drop") == 0) {
        return get_drop_request_object(node);
    } else if (strcmp(query_type, "select") == 0) {
        return get_select_request_object(node);
    } else if (strcmp(query_type, "update") == 0) {
        return get_update_request_object(node);
    } else if (strcmp(query_type, "insert") == 0) {
        return get_insert_request_object(node);
    } else if (strcmp(query_type, "delete") == 0) {
        return get_delete_request_object(node);
    }
    return NULL;
}
...
char *get_failure_response(char *msg) {
    WJElement element = WJEObject(NULL, NULL, WJE_NEW);
    WJEString(element, "status", WJE_SET, "failed");
    WJEString(element, "msg", WJE_SET, msg);
    return WJEToString(element, FALSE);
}
